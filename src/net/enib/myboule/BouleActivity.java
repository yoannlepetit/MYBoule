...
import net.enib.myboule.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class BouleActivity extends Activity {
	/**
	...
	/**
	 * Canvas screen qui va nous permettre de dessiner le cercle
	 */
	private View screen;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		screen = new ScreenAccelerator(this);
